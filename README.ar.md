...
# 🦁 XXD Panel 006｜مسرح الفراغ الصغير
...
## نماذج 16:9 بتكوين جانبي

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 006 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 006 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 006 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 006 نموذج 8"></td>
  </tr>
</table>

## نماذج 3:4 بتكوين أعلى–أسفل

أربع مصادر أخرى مستقلة، مختلفة عن مجموعة 16:9، بلوحة 3:4 مكتملة: الواقع أعلى والتصميم أسفل، مناصفة دقيقة 50:50. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 006. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 006 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 006 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 006 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 006 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>
...
عندما تتحول الصورة إلى ملصق أو غلاف أو محتوى اجتماعي أو خلفية شاشة، لا تكون المسألة مجرد تغيير الأسلوب. التحدي الحقيقي هو إعادة التصميم مع الحفاظ على هوية الموضوع والعلاقات الأساسية والمزاج وسهولة التعرّف.

يناسب **Panel 006** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **يحوّل الصورة إلى غلاف كتاب فني بموضوع صغير ومساحة ورقية واسعة**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.

### استخدمه في هذه الحالات

- **عندما يجب تثبيت المحتوى:** لا تريد استبدال الأشخاص أو الأشياء أو الحركة أو العلاقات بقالب لا صلة له بالصورة.
- **عندما تحتاج الصورة إلى تعبير أوضح:** تريد لغة تحريرية أو معالجة فنية أو تركيزاً سردياً أقوى.
- **عندما تحتاج إلى تسليم مرن:** تريد من المصدر نفسه مقارنة، أو تصميماً مستقلاً، أو نسباً متعددة، أو حزمة خلفيات.

### طريقة بسيطة للبدء

لا تحتاج إلى مراجعة كل الخيارات أولاً. أرسل صورة إلى الوكيل واطلب:

> استخدم XXD Panel 006 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.

راجع النماذج أعلاه إذا أردت تأكيد الاتجاه البصري أولاً. وعندما تكون مستعداً، انتقل إلى [البدء](#البدء). تبقى الأوضاع والمقاسات والمعاملات الكاملة متاحة داخل المرجع القابل للتوسيع.
<!-- xxd-human-intro:end -->

<!-- xxd-panel-benefit:start -->
## تحقق سريع: هل XXD Panel 006 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | يحوّل الصورة إلى غلاف كتاب فني بموضوع صغير ومساحة ورقية واسعة |
| **السمات التي تُعرف من النظرة الأولى** | موضوع 10–20% · ورق 80–90% · خط يدوي رفيع · أربعة ألوان كحد أقصى · أكريليك مسطح |
...
- [مهايئ التشغيل الصيني](references/xxd-panel-006-prompt.zh-CN.md)
- [مهايئ التشغيل الإنجليزي](references/xxd-panel-006-prompt.en.md)
- [موجز الأسلوب الأصلي](references/original-prompt/zh-CN.md)

## الموجّه الأصلي · خمس لغات

[فتح دليل الترجمات الموحّد](references/original-prompt/): [الأصل بالصينية المبسّطة](references/original-prompt/zh-CN.md) · [English](references/original-prompt/en.md) · [日本語](references/original-prompt/ja.md) · [한국어](references/original-prompt/ko.md) · [العربية](references/original-prompt/ar.md)

يحفظ ملف الصينية المبسّطة صياغة شياوشياودونغ حرفياً، وهو المرجع الجمالي الوحيد عند التشغيل. الملفات الأربعة الأخرى ترجمات أمينة للقراءة والمشاركة دولياً، ولا تعيد كتابة موجّه توليد الصور.
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 006. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-006 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-006 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-006 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-006 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-006 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 006 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-006 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
- يعيد كل نمط عادي مختار ملفاً واحداً، ويضيف اختيار `wallpaper-pack` أربع خلفيات مستقلة. يعيد خيار «الكل» سبعة ملفات PNG لكل مصدر مباشرة داخل مجلد مهمة جديد واحد، ولا ينشئ لوحة تجميع أو عرضاً عاماً أو مجلدات فرعية للأنماط.
...
## دليل XXD Panel التاريخي

يسرد هذا الجدول دليل Panel التاريخي من 001 إلى 060. يحتفظ كل إدخال بموجّهه الأصلي ومنطقه الجمالي المستقل، مع تمييز المشروع الحالي بخط عريض.
