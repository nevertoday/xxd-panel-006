...
The repository reserves [`assets/examples/`](assets/examples/) for future work. Only finished 006 artwork verified by the project owner will be added; no post or image from another style is used as a placeholder.

Future samples will demonstrate 006's adaptability. Their subjects, whitespace ratios, palette, copy, and canvas ratios will never become generation references or defaults.
