...
`references/006-source.md` is this project's sole creative and aesthetic authority. The Skill no longer summarizes or expands it, and it does not impose a shared palette, colour plan, aesthetic motive, title, or microcopy package. GPT Image 2 follows that brief's own rules for colour, material, composition, whitespace, wording, and typography.
...
- [Original style brief](references/006-source.md)
...
Each of the 57 Panels preserves its own original brief and aesthetic logic. The table lists every project address and its defining style characteristics; the current project is bold.
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–057) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
